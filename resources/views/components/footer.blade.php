...
<section class="w-full bg-cover bg-center z-10 texting">
    ...
    <div class="w-full max-w-6xl mx-auto py-20 grid grid-cols-1 sm:grid-cols-2 gap-10 sm:gap-20 px-4 ">
        <div class="text-[#ffffff] text-[12px]">
            ...
            <div class="flex items-center space-x-3 mt-10">
                <div>
                    <svg class="w-6 h-6 text-[#ffffff]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    <p class="relative text-center md:text-end md:mr-[50px] lg:mr-[150px] xl:mr-[280px] 2xl:mr-[380px] bottom-5 text-[12px] text-[#DFB266]">A2Z M&E Engineering Co.,Ltd All Right Reserved</p>
</section>
